...
- Roto has gotten its first looping construct: `while`. (#194)
...
- The CLI is now gated by a `cli` feature. (#175)
...
- The documentation of Roto was moved from the Rotonda repository to the Roto
  repository and greatly expanded. (#192)
