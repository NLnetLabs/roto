        ...
        match &expr.node {
            ...
            Assign(p, e) => {
                ...
                let ResolvedPath::Value(path_value) = resolved_path else {
                    return Err(
                        self.error_cannot_assign_to_this_expression(p)
                    );
                };
            ...
            CompoundAssign(c) => {
                ...
                let ResolvedPath::Value(path_value) = resolved_path else {
                    return Err(
                        self.error_cannot_assign_to_this_expression(&c.path)
                    );
                };
            ...
            IfElse(c, t, e) => {
                ...
                if let Some(e) = e {
                    // An if-else statement diverges if _both_ of its branches
                    // diverge.
